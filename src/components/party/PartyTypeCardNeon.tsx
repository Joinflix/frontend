...
const PartyTypeCardNeon = ({
  ...
  return (
    <div
      onClick={onClick}
      className={`w-[50%] rounded-sm flex flex-col justify-center px-2.5 py-3 gap-1 cursor-pointer transition-all
        ${
          active
            ? "border-2 border-[#E6E0FF] scale-105"
...
export default PartyTypeCardNeon;
